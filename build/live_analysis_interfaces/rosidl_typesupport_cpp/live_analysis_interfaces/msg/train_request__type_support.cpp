...
static const _TrainRequest_type_support_symbol_names_t _TrainRequest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, live_analysis_interfaces, msg, TrainRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, live_analysis_interfaces, msg, TrainRequest)),
  }
};
...
{
  return &::live_analysis_interfaces::msg::rosidl_typesupport_cpp::TrainRequest_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, live_analysis_interfaces, msg, TrainRequest)() {
  return get_message_type_support_handle<live_analysis_interfaces::msg::TrainRequest>();
}
