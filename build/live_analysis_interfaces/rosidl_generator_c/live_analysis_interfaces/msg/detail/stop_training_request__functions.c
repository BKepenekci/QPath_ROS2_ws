...
live_analysis_interfaces__msg__StopTrainingRequest__init(live_analysis_interfaces__msg__StopTrainingRequest * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    live_analysis_interfaces__msg__StopTrainingRequest__fini(msg);
    return false;
  }
  // user_id
...
live_analysis_interfaces__msg__StopTrainingRequest__create()
{
  ...
  live_analysis_interfaces__msg__StopTrainingRequest * msg = (live_analysis_interfaces__msg__StopTrainingRequest *)allocator.allocate(sizeof(live_analysis_interfaces__msg__StopTrainingRequest), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(live_analysis_interfaces__msg__StopTrainingRequest));
  bool success = live_analysis_interfaces__msg__StopTrainingRequest__init(msg);
  if (!success) {
...
live_analysis_interfaces__msg__StopTrainingRequest__Sequence__init(live_analysis_interfaces__msg__StopTrainingRequest__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  live_analysis_interfaces__msg__StopTrainingRequest * data = NULL;

  if (size) {
    data = (live_analysis_interfaces__msg__StopTrainingRequest *)allocator.zero_allocate(size, sizeof(live_analysis_interfaces__msg__StopTrainingRequest), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = live_analysis_interfaces__msg__StopTrainingRequest__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        live_analysis_interfaces__msg__StopTrainingRequest__fini(&data[i - 1]);
      }
...
live_analysis_interfaces__msg__StopTrainingRequest__Sequence__fini(live_analysis_interfaces__msg__StopTrainingRequest__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      live_analysis_interfaces__msg__StopTrainingRequest__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  live_analysis_interfaces__msg__StopTrainingRequest__Sequence * array = (live_analysis_interfaces__msg__StopTrainingRequest__Sequence *)allocator.allocate(sizeof(live_analysis_interfaces__msg__StopTrainingRequest__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = live_analysis_interfaces__msg__StopTrainingRequest__Sequence__init(array, size);
  if (!success) {
...
live_analysis_interfaces__msg__StopTrainingRequest__Sequence__destroy(live_analysis_interfaces__msg__StopTrainingRequest__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    live_analysis_interfaces__msg__StopTrainingRequest__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
