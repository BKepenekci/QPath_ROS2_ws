...
#include "live_analysis_interfaces/msg/detail/test_request_client__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // id, image_paths, model_id, model_path, yolo_path
#include "rosidl_runtime_c/string_functions.h"  // id, image_paths, model_id, model_path, yolo_path
...
using _TestRequestClient__ros_msg_type = live_analysis_interfaces__msg__TestRequestClient;

static bool _TestRequestClient__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TestRequestClient__ros_msg_type * ros_message = static_cast<const _TestRequestClient__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: yolo_path
  {
    const rosidl_runtime_c__String * str = &ros_message->yolo_path;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
...
static bool _TestRequestClient__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _TestRequestClient__ros_msg_type * ros_message = static_cast<_TestRequestClient__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: yolo_path
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->yolo_path.data) {
      rosidl_runtime_c__String__init(&ros_message->yolo_path);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->yolo_path,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'yolo_path'\n");
      return false;
    }
  }
...
size_t get_serialized_size_live_analysis_interfaces__msg__TestRequestClient(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TestRequestClient__ros_msg_type * ros_message = static_cast<const _TestRequestClient__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TestRequestClient__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_live_analysis_interfaces__msg__TestRequestClient(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_live_analysis_interfaces
size_t max_serialized_size_live_analysis_interfaces__msg__TestRequestClient(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _TestRequestClient__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_live_analysis_interfaces__msg__TestRequestClient(
...
static message_type_support_callbacks_t __callbacks_TestRequestClient = {
  "live_analysis_interfaces::msg",
  "TestRequestClient",
  _TestRequestClient__cdr_serialize,
  _TestRequestClient__cdr_deserialize,
  _TestRequestClient__get_serialized_size,
  _TestRequestClient__max_serialized_size
};

static rosidl_message_type_support_t _TestRequestClient__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TestRequestClient,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, live_analysis_interfaces, msg, TestRequestClient)() {
  return &_TestRequestClient__type_support;
}
