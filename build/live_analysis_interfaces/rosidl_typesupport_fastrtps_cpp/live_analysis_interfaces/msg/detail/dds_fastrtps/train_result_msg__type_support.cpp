...
#include "live_analysis_interfaces/msg/detail/train_result_msg__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = live_analysis_interfaces::msg::TrainResultMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const live_analysis_interfaces::msg::TrainResultMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<live_analysis_interfaces::msg::TrainResultMsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TrainResultMsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const live_analysis_interfaces::msg::TrainResultMsg *>(
...
static size_t _TrainResultMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TrainResultMsg(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TrainResultMsg__callbacks = {
...
static rosidl_message_type_support_t _TrainResultMsg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TrainResultMsg__callbacks,
...
get_message_type_support_handle<live_analysis_interfaces::msg::TrainResultMsg>()
{
  return &live_analysis_interfaces::msg::typesupport_fastrtps_cpp::_TrainResultMsg__handle;
}
