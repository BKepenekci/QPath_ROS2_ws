...
#include "live_analysis_interfaces/msg/detail/test_model_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const live_analysis_interfaces::msg::TestModelMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  live_analysis_interfaces::msg::TestModelMsg & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_live_analysis_interfaces
max_serialized_size_TestModelMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = live_analysis_interfaces::msg::TestModelMsg;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_live_analysis_interfaces
max_serialized_size_key_TestModelMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const live_analysis_interfaces::msg::TestModelMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<live_analysis_interfaces::msg::TestModelMsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TestModelMsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const live_analysis_interfaces::msg::TestModelMsg *>(
...
static size_t _TestModelMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TestModelMsg(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TestModelMsg__callbacks = {
...
static rosidl_message_type_support_t _TestModelMsg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TestModelMsg__callbacks,
...
{
  return &live_analysis_interfaces::msg::typesupport_fastrtps_cpp::_TestModelMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, live_analysis_interfaces, msg, TestModelMsg)() {
  return &live_analysis_interfaces::msg::typesupport_fastrtps_cpp::_TestModelMsg__handle;
}
