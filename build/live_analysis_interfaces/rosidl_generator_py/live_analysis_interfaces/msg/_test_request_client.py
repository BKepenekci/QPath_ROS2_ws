...
class Metaclass_TestRequestClient(type):
    """Metaclass of message 'TestRequestClient'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'live_analysis_interfaces.msg.TestRequestClient')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__test_request_client
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__test_request_client
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__test_request_client
            cls._TYPE_SUPPORT = module.type_support_msg__msg__test_request_client
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__test_request_client
...
class TestRequestClient(metaclass=Metaclass_TestRequestClient):
    """Message class 'TestRequestClient'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.yolo_path = kwargs.get('yolo_path', str())
    ...
    def __eq__(self, other):
        ...
        if self.model_path != other.model_path:
            return False
        if self.yolo_path != other.yolo_path:
            return False
    ...
    @builtins.property
    def yolo_path(self):
        """Message field 'yolo_path'."""
        return self._yolo_path

    @yolo_path.setter
    def yolo_path(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'yolo_path' field must be of type 'str'"
        self._yolo_path = value
