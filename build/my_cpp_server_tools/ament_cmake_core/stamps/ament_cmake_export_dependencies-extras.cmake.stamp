...
# variables to my_cpp_server_tools_DEFINITIONS, my_cpp_server_tools_INCLUDE_DIRS,
# my_cpp_server_tools_LIBRARIES, and my_cpp_server_tools_LINK_FLAGS.
# Additionally collect the direct dependency names in
# my_cpp_server_tools_DEPENDENCIES as well as the recursive dependency names
# in my_cpp_server_tools_RECURSIVE_DEPENDENCIES.
if(NOT _exported_dependencies STREQUAL "")
  find_package(ament_cmake_core QUIET REQUIRED)
  set(my_cpp_server_tools_DEPENDENCIES ${_exported_dependencies})
  set(my_cpp_server_tools_RECURSIVE_DEPENDENCIES ${_exported_dependencies})
  set(_libraries)
  foreach(_dep ${_exported_dependencies})
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(my_cpp_server_tools_INCLUDE_DIRS "${_include_dirs}")
          endif()
    ...
    if(NOT use_modern_cmake)
      if(${_dep}_DEFINITIONS)
        list_append_unique(my_cpp_server_tools_DEFINITIONS "${${_dep}_DEFINITIONS}")
      endif()
      if(${_dep}_INCLUDE_DIRS)
        list_append_unique(my_cpp_server_tools_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
      endif()
      if(${_dep}_LIBRARIES)
        list(APPEND _libraries "${${_dep}_LIBRARIES}")
      endif()
      if(${_dep}_LINK_FLAGS)
        list_append_unique(my_cpp_server_tools_LINK_FLAGS "${${_dep}_LINK_FLAGS}")
      endif()
      if(${_dep}_RECURSIVE_DEPENDENCIES)
        list_append_unique(my_cpp_server_tools_RECURSIVE_DEPENDENCIES "${${_dep}_RECURSIVE_DEPENDENCIES}")
      endif()
    endif()
    if(_libraries)
      ament_libraries_deduplicate(_libraries "${_libraries}")
      list(APPEND my_cpp_server_tools_LIBRARIES "${_libraries}")
    endif()
  endforeach()
endif()
