...
class SimpleNet(torch.nn.Module):
    ...
    def test(self, training_data, test_data, save_segmentation_images):
        ...
        print("Running test with \"test_data\"...\n\n\nTest Data\n______________________________\n\nType of Test Data : " + str(type(test_data)) + "\n\nContents of Test Data: " + str(test_data) + "\n\n10 Elements of \"test_data.dataset.data_to_iterate\": " + str(test_data.dataset.data_to_iterate[50:60]) + "\n\nLength of Data to Iterate: " + str(len(test_data.dataset.data_to_iterate)) + "\n\nType of \"test_data.dataset\": " + str(type(test_data.dataset)) + "\n\n")
        ...
        shape_of_scores = scores.shape
        shape_of_segmentations = segmentations.shape

        print("Returned from predict method to test method...\n\n\nResults of Predict Method\n\n\nScores: " + str(scores[:10]) + "\n\nType of Scores: " + str(type(scores)) + "\n\nSize of Scores: " + str(shape_of_scores) + "\n\nFirst Element of Segmentations: " + str(segmentations[0]) + "\n\nType of Segmentations: " + str(type(segmentations)) + "\n\nSize of Segmentations: " + str(shape_of_segmentations) + "\n\n\n")
