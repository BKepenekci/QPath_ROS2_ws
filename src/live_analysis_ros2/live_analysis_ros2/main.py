    ...
    for dataloader_count, dataloaders in enumerate(list_of_dataloaders):
        ...
        for i, SimpleNet in enumerate(simplenet_list):
            ...
            if not test:
                ...
                print("Entering into test function...\n\n")
                ...
                auroc, full_pixel_auroc =  SimpleNet.test(dataloaders["training"], dataloaders["testing"], True)
                #print("Warning: Pls set test with true by default")
            if not test:
                print("Finished Testing\n________________________\nDataset Name: " + dataset_name + "\nInstance Auroc: " + str(i_auroc) + "\nFull Pixel Auroc: " + str(p_auroc) + "\nAnomaly Pixel AUROC: " + str(pro_auroc) + "\n\n")
                ...
                print("Finished Testing\n________________________\nDataset Name: " + dataset_name + "\nInstance Auroc: " + str(auroc) + "\nFull Pixel Auroc: " + str(full_pixel_auroc) + "\n\n")
                result_collect.append(
                    {
                        "dataset_name": dataset_name,
